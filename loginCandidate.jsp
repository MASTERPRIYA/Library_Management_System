        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type=" submit"  class="btn btn-dark px-5 mr-5 mt-5">Save</button>
                </div>
            </div>
        </div>
    </div>
...
<!--*********************************************<QR-CODE>-START************************************************-->
    <div class="modal fade modal-lg" tabindex="-1"  id="save_member">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Scan QR and Pay 1000 to become the member of library (per month)</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form action="memberShip.do" method="post">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary  px-5 mr-5 mt-5" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-dark px-5 mr-5 mt-5">Proceed Payment</button>
                </div>
            </div>
        </div>
    </div>  
...
<!--*********************************************Change Password-END******************************************-->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
         ...
         <div class="row">
            ...
            <div class="col-10  border border-dark bg-gradient" style="height:600px; width:50%;  margin-top:80px; margin-left:18%;background-color:rgb(0, 150, 255); ">

                <form action="loginCandidate.do" method="post" style="margin-top:100px; margin-left:50px;">

                    <label for="email" class="form-label mr-5" style="color: rgb(255, 255, 255);"><h3>Email :</h3></label><br>  
                    <input type="email" class="form-control mb-5 px-5" id="email"  name="email" style="padding-right:700px;" required="required">
                    ...
                    <button type="button" class="btn btn-light btn-lg px-5 m-4">
                        <a style="text-decoration: none; color: rgb(0, 0, 0);" href="index.jsp">Exit</a>
                    </button>
                    <!-- <a href="#" class="btn btn-warning" style="text-decoration:none;color:rgb(0, 0, 0);border-radius:15px;margin-left:85%" data-bs-toggle="modal" data-bs-target="#member">Membership</a> -->
                </form>
    ...
    <script>
        ...
        let emailExist = true;
        let loginCandidateMenu = document.querySelector('#loginCandidateMenu');
